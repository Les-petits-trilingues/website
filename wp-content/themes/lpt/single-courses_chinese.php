...
if (have_posts()):
	...
	<main class="pb-24">
		...
		<!-- Content top images (listing in one column) -->
		<?php if ($course->contentTopImages): ?>
			<section class="container mx-auto">
				<?php foreach (Arr::wrap($course->contentTopImages) as $image): ?>
					<img src="<?= $image ?>" alt="" class="mx-auto mb-6"/>
				<?php endforeach; ?>
			</section>
		<?php endif; ?>
